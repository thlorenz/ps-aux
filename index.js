 ...
 */
proto.obtain =  function obtain(cb) {
  yawn('ps', [ 'aux'], { trackStdout: true, trackStderr: true }, onran);
  function onran(err, buf) {
    if (err) return cb(err);
    // ignore header line and last line which is always empty
